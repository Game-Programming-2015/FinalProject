...
FliesData:
	...
	.global	FliesPalette
	.align	1
	.type	FliesPalette, %object
	.size	FliesPalette, 512
FliesPalette:
	.short	0
	.short	2
	.short	1086
...
playerCollisionHandler:
	...
	@ frame_needed = 0, uses_anonymous_args = 0
	@ link register save eliminated.
	cmp	r0, #2	@  collisionID
	@ lr needed for prologue
	mov	r1, #0	@  r
	beq	.L154
	bgt	.L160
	cmp	r0, r1	@  collisionID
	beq	.L151
...
.L161:
	...
	b	.L151
.L160:
	cmp	r0, #4	@  collisionID
	beq	.L157
	blt	.L156
	mov	r3, #1024
	add	r3, r3, #3
	cmp	r0, r3	@  collisionID
	bne	.L158
.L156:
	mov	r3, #83886080
	add	r3, r3, #556
...
addMoveable:
	...
	mov	r4, r0	@  head
	sub	fp, ip, #4
	moveq	r4, r1	@  head,  toAdd
	beq	.L164
	ldr	r0, [r0, #28]	@  head,  <variable>.next
	bl	addMoveable
	str	r0, [r4, #28]	@  head,  <variable>.next
.L164:
	mov	r0, r4	@  head
	ldmea	fp, {r4, fp, sp, lr}
	bx	lr
	.size	addMoveable, .-addMoveable
	.align	2
	.global	spriteWidth
	.type	spriteWidth, %function
spriteWidth:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
...
.L177:
	mov	r0, #32	@  r
	bx	lr
	.size	spriteWidth, .-spriteWidth
	.align	2
	.global	checkTwoHitBoxCollision
	.type	checkTwoHitBoxCollision, %function
checkTwoHitBoxCollision:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 1, uses_anonymous_args = 0
	mov	ip, sp
	stmfd	sp!, {r4, r5, r6, r7, r8, r9, sl, fp, ip, lr, pc}
	ldr	r6, [r0, #16]	@  one,  <variable>.parentSprite
	...
	mov	r4, r4, asl #23
	mov	r4, r4, lsr #23
	ldr	r2, [r5, #0]	@  <variable>.x
	add	r4, r4, r0	@  one
	ldr	r3, [r5, #8]	@  <variable>.xSize
	rsb	sl, r2, r4	@  rightOne
	rsb	r9, r3, sl	@  leftOne,  rightOne
.L184:
	ldr	r8, [r7, #16]	@  one,  <variable>.parentSprite
	ldrb	r1, [r6, #0]	@ zero_extendqisi2	@ * one
	ldr	r2, [r5, #4]	@  <variable>.y
	ldrb	r3, [r8, #3]	@ zero_extendqisi2
	ldr	ip, [r5, #12]	@  <variable>.ySize
	tst	r3, #16
	add	r5, r2, r1	@  topOne
	mov	r0, r8	@  one
	add	r6, r5, ip	@  bottomOne,  topOne
	beq	.L185
	bl	spriteWidth
	ldrh	r4, [r8, #2]
	mov	r4, r4, asl #23
	ldr	r2, [r7, #0]	@  <variable>.x
	mov	r4, r4, lsr #23
	add	r4, r4, r0	@  one
	ldr	r3, [r7, #8]	@  <variable>.xSize
	rsb	r4, r2, r4	@  rightTwo
	rsb	r2, r3, r4	@  leftTwo,  rightTwo
.L186:
	cmp	sl, r2	@  rightOne,  leftTwo
	movle	r3, #0
	movgt	r3, #1
	ldrb	r1, [r8, #0]	@ zero_extendqisi2	@ * one
	ldr	r2, [r7, #4]	@  <variable>.y
	ldr	r0, [r7, #12]	@  <variable>.ySize
	mov	ip, #0	@  one
	cmp	r9, r4	@  leftOne,  rightTwo
	movge	r3, #0
	andlt	r3, r3, #1
	add	r2, r2, r1	@  topTwo
	cmp	r3, ip
	add	r0, r2, r0	@  bottomTwo,  topTwo
	beq	.L187
	cmp	r5, r0	@  topOne,  bottomTwo
	movge	r3, #0
	movlt	r3, #1
	cmp	r6, r2	@  bottomOne,  topTwo
	movle	ip, #0	@  one
	andgt	ip, r3, #1	@  one
.L187:
	mov	r0, ip	@  one
...
.L185:
	...
	ldr	r2, [r7, #0]	@  <variable>.x
	mov	r3, r3, asl #23
	ldr	r1, [r7, #8]	@  <variable>.xSize
	mov	r3, r3, lsr #23
	add	r2, r2, r3	@  leftTwo
	add	r4, r2, r1	@  rightTwo,  leftTwo
	b	.L186
.L183:
	ldrh	r3, [r6, #2]
	ldr	r1, [r5, #0]	@  <variable>.x
	mov	r3, r3, asl #23
	mov	r3, r3, lsr #23
	ldr	r2, [r5, #8]	@  <variable>.xSize
	add	r9, r1, r3	@  leftOne
	add	sl, r9, r2	@  rightOne,  leftOne
	b	.L184
	.size	checkTwoHitBoxCollision, .-checkTwoHitBoxCollision
	.align	2
	.global	DMAFastCopy
...
loadLevelOneHitMap:
	...
	sub	sl, fp, #40
	sub	ip, ip, #24
	strh	r3, [sl, lr]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	lr, fp, #4096
	sub	ip, fp, #4080
	sub	lr, lr, #8
	sub	ip, ip, #8
	strh	r3, [lr, #0]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	lr, fp, #4064
	sub	ip, fp, #4048
	sub	lr, lr, #8
	...
	sub	lr, lr, #8
	sub	ip, ip, #8
	strh	r3, [r4, #2]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #4]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #6]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #8]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #10]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #12]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #14]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #18]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #20]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #22]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #24]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #26]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #28]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #30]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #34]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #36]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #38]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #40]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #42]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #44]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #46]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #50]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #52]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #54]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #56]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #58]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #60]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #62]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #66]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [lr, #0]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #3872
	sub	lr, fp, #4000
	...
	add	ip, ip, #14
	mov	lr, #2	@ movhi
	strh	lr, [r4, ip]	@ movhi 	@  LevelOnePlatforms_Map
	...
	mov	r0, r6	@  location
	mov	r6, #1
	strh	r3, [r4, #68]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #70]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #72]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #74]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #76]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #78]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #82]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #84]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #86]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #88]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #90]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #92]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #94]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #98]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #100]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #102]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #104]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #106]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #108]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #110]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #114]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #116]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #118]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #120]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #122]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #124]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #126]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, #254]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r6, [r4, sl]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #4096
	ldr	ip, [ip, #-48]
	strh	r3, [r4, ip]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #3616
	sub	ip, ip, #8
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #3488
	...
	sub	ip, fp, #4096
	ldr	ip, [ip, #-72]
	strh	r3, [r4, lr]	@ movhi 	@  LevelOnePlatforms_Map
	sub	lr, fp, #4096
	ldr	lr, [lr, #-64]
	strh	r6, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	sl, fp, #4096
	sub	ip, fp, #3104
	ldr	sl, [sl, #-56]
	sub	ip, ip, #8
	strh	r6, [lr, #0]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	lr, fp, #4096
	sub	ip, fp, #2976
	strh	r3, [r4, sl]	@ movhi 	@  LevelOnePlatforms_Map
	...
	add	lr, lr, #12
	sub	ip, fp, #2848
	strh	r6, [r4, lr]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, ip, #8
	sub	lr, fp, #4096
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	ldr	lr, [lr, #-84]
	...
	add	r8, r8, r7
	add	ip, ip, #10
	strh	r8, [r4, ip]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #4096
	ldr	ip, [ip, #-88]
	strh	r3, [r4, ip]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #2592
	...
	add	ip, ip, #6
	mov	r5, #4
	strh	r5, [r4, ip]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #2384
	sub	ip, ip, #8
	strh	r7, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #4096
	ldr	ip, [ip, #-96]
	mov	sl, #1456
	strh	r8, [r4, ip]	@ movhi 	@  LevelOnePlatforms_Map
	add	sl, sl, #8
	sub	ip, fp, #2336
	strh	r7, [r4, sl]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, ip, #8
	mov	lr, #1488
	mov	sl, #1488
	add	lr, lr, r5
	...
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #2208
	strh	r7, [r4, lr]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r8, [r4, sl]	@ movhi 	@  LevelOnePlatforms_Map
	sub	lr, fp, #4096
	sub	ip, ip, #8
	mov	sl, #1680
	ldr	lr, [lr, #-92]
	...
	mov	sl, #1680
	strh	r3, [r4, lr]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r7, [r4, ip]	@ movhi 	@  LevelOnePlatforms_Map
	add	sl, sl, #10
	sub	ip, fp, #2080
	mov	lr, #1680
	strh	r5, [r4, sl]	@ movhi 	@  LevelOnePlatforms_Map
	...
	sub	sl, fp, #4096
	sub	ip, ip, #8
	strh	r5, [r4, lr]	@ movhi 	@  LevelOnePlatforms_Map
	ldr	sl, [sl, #-104]
	sub	lr, fp, #4096
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	ip, fp, #4096
	...
	add	lr, lr, #14
	sub	ip, ip, #8
	strh	r8, [r4, lr]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [r4, sl]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	mov	lr, #2176
	sub	ip, fp, #1888
	...
	sub	lr, lr, #8
	strh	r5, [r4, sl]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r7, [lr, #0]	@ movhi 	@  LevelOnePlatforms_Map
	sub	sl, fp, #4096
	sub	ip, ip, #8
	sub	lr, fp, #4096
	ldr	sl, [sl, #-132]
	...
	strh	r3, [r4, lr]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [ip, #0]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-170]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-168]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-166]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-164]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-162]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-160]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-158]	@ movhi 	@  LevelOnePlatforms_Map
	mov	r1, r4	@  location
	strh	r3, [fp, #-156]	@ movhi 	@  LevelOnePlatforms_Map
	ldr	ip, .L212+4
	strh	r3, [fp, #-154]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-152]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-150]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-148]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-146]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-144]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-142]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-140]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-138]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-136]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-134]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-132]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-130]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-128]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-126]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-124]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-122]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-120]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-118]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-116]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-114]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-112]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-110]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-108]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-106]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-104]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-102]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-42]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-100]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-98]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-96]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-94]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-92]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-90]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-88]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-86]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-84]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-82]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-80]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-78]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-76]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-74]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-72]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-70]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-68]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-66]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-64]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-62]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-60]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-58]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-56]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-54]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-52]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-50]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-48]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-46]	@ movhi 	@  LevelOnePlatforms_Map
	strh	r3, [fp, #-44]	@ movhi 	@  LevelOnePlatforms_Map
	mov	lr, pc
	bx	ip
	ldmea	fp, {r4, r5, r6, r7, r8, r9, sl, fp, sp, lr}
	bx	lr
...
.LC0:
	...
	.text
	.align	2
	.global	loadLevelOneHitMapTiles
	.type	loadLevelOneHitMapTiles, %function
loadLevelOneHitMapTiles:
	@ Function supports interworking.
...
.L215:
	.word	.LC0
	.word	memcpy
	.size	loadLevelOneHitMapTiles, .-loadLevelOneHitMapTiles
	.align	2
...
loadLevelOnePalette:
	...
	add	r4, r4, #8
	mov	r3, #10752
	strh	r4, [r9, ip]	@ movhi 	@  LevelOnePalette_Palette
	add	r3, r3, #21
	ldr	r9, [fp, #-556]
	str	r3, [fp, #-600]
	sub	r4, fp, #40
	...
	sub	r4, fp, #512
	strh	lr, [r9, ip]	@ movhi 	@  LevelOnePalette_Palette
	ldrh	ip, [r4, #-104]	@ movhi
	ldr	r9, [fp, #-612]
	sub	r4, fp, #40
	sub	lr, fp, #512
	strh	ip, [r4, r9]	@ movhi 	@  LevelOnePalette_Palette
	ldrh	r9, [lr, #-112]	@ movhi
	ldr	r4, [fp, #-620]
	sub	lr, fp, #40
	sub	ip, fp, #512
	strh	r9, [lr, r4]	@ movhi 	@  LevelOnePalette_Palette
	ldrh	r4, [ip, #-120]	@ movhi
	ldr	lr, [fp, #-628]
	sub	ip, fp, #40
	strh	r4, [ip, lr]	@ movhi 	@  LevelOnePalette_Palette
	mov	r5, #24832
	...
	sub	r9, fp, #40
	add	r5, r5, #8
	strh	r5, [r9, ip]	@ movhi 	@  LevelOnePalette_Palette
	ldr	r4, [fp, #-640]
	mov	r7, #8320
	mov	r8, #-2013265920
	mvn	sl, #476
	...
	mov	r2, #256
	mov	r3, #-2147483648
	strh	r7, [lr, r4]	@ movhi 	@  LevelOnePalette_Palette
	strh	ip, [r9, r8]	@ movhi 	@  LevelOnePalette_Palette
	strh	r6, [lr, sl]	@ movhi 	@  LevelOnePalette_Palette
	bl	DMAFastCopy
	ldmea	fp, {r4, r5, r6, r7, r8, r9, sl, fp, sp, lr}
	bx	lr
.L219:
...
.LC1:
	...
	.text
	.align	2
	.global	loadLevelOneBackgroundTiles
	.type	loadLevelOneBackgroundTiles, %function
loadLevelOneBackgroundTiles:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 7936
	@ frame_needed = 1, uses_anonymous_args = 0
	mov	ip, sp
	stmfd	sp!, {r4, r5, fp, ip, lr, pc}
	sub	fp, ip, #4
	sub	r4, fp, #7936	@  location
	sub	sp, sp, #7936
	sub	r4, r4, #20	@  location,  location
	mov	r5, r0	@  location
	mov	r2, #7936
	ldr	r1, .L221
	mov	r0, r4	@  location
...
.L221:
	.word	.LC1
	.word	memcpy
	.size	loadLevelOneBackgroundTiles, .-loadLevelOneBackgroundTiles
	.section	.rodata
	.align	1
.LC2:
	.short	0
	...
	.text
	.align	2
	.global	loadLevelOneMap
	.type	loadLevelOneMap, %function
loadLevelOneMap:
	@ Function supports interworking.
	...
	sub	fp, ip, #4
	sub	r5, fp, #4096	@  location
	sub	sp, sp, #4096
	sub	r5, r5, #28	@  location,  location
	mov	r6, #4096
	mov	r4, r0	@  location
	mov	r2, r6
	ldr	r7, .L224
...
.L224:
	.word	memcpy
	.word	.LC2
	.size	loadLevelOneMap, .-loadLevelOneMap
	.global	bg0map
	.data
	.align	2
	.type	bg0map, %object
...
init:
	...
	mov	r3, #8000	@ movhi
	sub	fp, ip, #4
	strh	r3, [r2, #4]	@ movhi 	@  channelMus.sampleRate
	ldr	r3, .L234+4
	mov	lr, pc
	bx	r3
	ldr	r2, .L234+8
...
.L254:
	...
	.word	malloc
	.word	tongueObjectSetup
	.size	playerObjectSetup, .-playerObjectSetup
	.align	2
	.global	tongueObjectSetup
	.type	tongueObjectSetup, %function
tongueObjectSetup:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
	...
	mov	r1, r1, asl #16
	mov	r3, r3, lsr #16
	str	r2, [ip, #16]	@  tongueHitBox.parentSprite
	orr	r3, r3, #240
	mvn	r2, #95
	mov	r1, r1, lsr #16
	strh	r3, [r0, #10]	@ movhi 
	strb	r2, [r0, #8]	@  <variable>.fields.y
	mov	r3, #0
	mov	r2, #8
	orr	r1, r1, #16
	strh	r1, [r0, #12]	@ movhi 
	str	r3, [ip, #0]	@  tongueHitBox.x
	str	r2, [ip, #4]	@  tongueHitBox.y
	mov	r3, #17
	mov	r2, #2
	@ lr needed for prologue
	str	r3, [ip, #8]	@  tongueHitBox.xSize
	str	r2, [ip, #12]	@  tongueHitBox.ySize
	bx	lr
.L258:
	.align	2
.L257:
	.word	sprites
	.word	tongueHitBox
	.size	tongueObjectSetup, .-tongueObjectSetup
	.align	2
	.global	flyObjectSetup
	.type	flyObjectSetup, %function
flyObjectSetup:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 1, uses_anonymous_args = 0
	...
	strh	r3, [r4, #18]	@ movhi 
	bic	r2, r2, #988
	ldrb	lr, [r4, #19]	@ zero_extendqisi2
	bic	r2, r2, #3
	...
	bic	lr, lr, #128
	mov	r2, r2, lsr #16
	strb	r3, [r4, #16]	@  <variable>.fields.y
	mov	r7, #0
	mov	ip, r0	@  flyOneHitbox
	orr	lr, lr, #64
	orr	r2, r2, #32
	mov	r3, #1
	add	r8, r4, r9
	...
	strb	r6, [r4, #17]
	mov	r1, r5	@  flyOne
	str	r7, [r5, #20]	@  <variable>.hSpeed
	str	r7, [r5, #24]	@  <variable>.vSpeed
	str	r8, [ip, #16]	@  <variable>.parentSprite
	str	r7, [ip, #0]	@  <variable>.x
	stmib	ip, {r7, r9}	@ phole stm
	str	r9, [ip, #12]	@  <variable>.ySize
	str	ip, [r5, #8]	@  flyOneHitbox,  <variable>.hitBoxList
	str	ip, [r5, #4]	@  flyOneHitbox,  <variable>.masterHitBox
	str	r3, [r5, #12]	@  <variable>.hitBoxCount
	str	r8, [r5, #0]	@  <variable>.parentSprite
	ldr	r0, .L260+8
	bl	addMoveable
	mov	r0, #32
	mov	lr, pc
	...
	strh	r2, [r4, #28]	@ movhi 
	mov	r1, r5	@  flyOne
	str	r6, [ip, #16]	@  <variable>.parentSprite
	str	ip, [r5, #8]	@  flyOneHitbox,  <variable>.hitBoxList
	ldr	r0, .L260+8
	strb	r8, [r4, #24]	@  flyOne,  <variable>.fields.y
	str	r7, [r5, #20]	@  <variable>.hSpeed
	str	r7, [r5, #24]	@  <variable>.vSpeed
	str	ip, [r5, #4]	@  flyOneHitbox,  <variable>.masterHitBox
	str	r7, [ip, #0]	@  <variable>.x
	stmib	ip, {r7, r9}	@ phole stm
	str	r9, [ip, #12]	@  <variable>.ySize
	str	r6, [r5, #0]	@  <variable>.parentSprite
	str	r3, [r5, #12]	@  <variable>.hitBoxCount
	bl	addMoveable
	mov	r0, r8	@  flyOne
	mov	lr, pc
	...
	mov	r2, r2, asl r9
	mov	r5, r0	@  flyOneHitbox
	mov	r2, r2, lsr r9
	mov	r3, #34
	bic	ip, ip, #128
	ldr	r0, .L260+8
	strb	r3, [r4, #32]	@  <variable>.fields.y
	add	r8, r4, r8
	bic	lr, lr, #192
	orr	ip, ip, #64
	orr	r2, r2, #96
	...
	strb	ip, [r4, #35]
	strh	r2, [r4, #36]	@ movhi 
	str	r7, [r5, #4]	@  <variable>.y
	str	r9, [r5, #12]	@  <variable>.ySize
	str	r8, [r5, #16]	@  <variable>.parentSprite
	str	r3, [r6, #12]	@  <variable>.hitBoxCount
	str	r7, [r6, #20]	@  <variable>.hSpeed
	str	r7, [r6, #24]	@  <variable>.vSpeed
	str	r5, [r6, #8]	@  flyOneHitbox,  <variable>.hitBoxList
	str	r8, [r6, #0]	@  <variable>.parentSprite
	str	r7, [r5, #0]	@  <variable>.x
	str	r9, [r5, #8]	@  <variable>.xSize
	str	r5, [r6, #4]	@  flyOneHitbox,  <variable>.masterHitBox
	ldmea	fp, {r4, r5, r6, r7, r8, r9, sl, fp, sp, lr}
	b	addMoveable
.L261:
	.align	2
.L260:
	...
	.word	sprites
	.word	moveableHead
	.size	flyObjectSetup, .-flyObjectSetup
	.align	2
...
backgroundSetup:
	...
	mov	r0, #100663296
	bl	loadLevelOneHitMapTiles
	mov	r0, #100663296
	add	r0, r0, #49152
	bl	loadLevelOneBackgroundTiles
	ldr	r0, [r5, #0]	@  hitMap
...
.L267:
	...
	mov	r6, #149	@  i
	mov	r5, #31
	str	r4, [lr, #0]	@  nextRight
	str	r7, [sp, #0]
	str	r5, [sp, #4]
	str	r6, [ip, #0]	@  i,  nextLeft
	ldr	ip, .L270+32
	mov	r1, r6	@  i
	str	r5, [ip, #0]	@  nextLeftDestination
	mov	r2, #64
	mov	r3, r9
	str	r9, [sp, #8]
	str	r9, [sp, #12]
	bl	copyColumn
	ldr	r3, .L270+28
	ldr	r1, [r3, #0]	@  i,  nextLeft
	ldr	r3, .L270+32
	ldr	ip, [r8, #0]	@  bg2map
	ldr	lr, [r3, #0]	@  nextLeftDestination
	ldr	r0, [sl, #0]	@  backMap
	mov	r3, r9
	mov	r2, #64
...
update:
	...
	bne	.L276
.L274:
	ldr	r2, [r7, #0]	@  scrolling_x
	ldr	r3, [r6, #0]	@  bg0map
	str	r2, [sp, #0]
	mov	r1, #1
	ldr	ip, [r8, #0]	@  scrolling_y
	ldr	r0, .L277+24
	mov	r2, r1
	str	ip, [sp, #4]
	bl	moveObject
...
.L272:
	...
	bx	lr
.L276:
	ldr	r1, [r7, #0]	@  scrolling_x
	ldr	r2, [r8, #0]	@  scrolling_y
	ldr	r3, [r6, #0]	@  bg0map
	bl	gravityControls
	b	.L274
.L278:
...
playerMovement:
	...
	beq	.L280
	ldr	r4, .L288
	ldr	r3, [r4, #0]	@  moveableHead.parentSprite
	ldrb	r2, [r3, #3]	@ zero_extendqisi2
	mov	r1, #4
	bic	r2, r2, #16
	strb	r2, [r3, #3]
.L286:
	str	r1, [r4, #20]	@  moveableHead.hSpeed
.L281:
	mov	r0, #64
	bl	checkPressed
	cmp	r0, #0
...
.L284:
	...
	cmp	r0, #0
	mvnne	r3, #9
	strne	r3, [r4, #24]	@  moveableHead.vSpeed
	ldmea	fp, {r4, fp, sp, lr}
	bx	lr
.L287:
	ldr	r3, .L288+4
	ldr	r0, .L288+8
	ldr	r2, [r3, #0]	@  scrolling_y
	ldr	ip, .L288+12
	ldr	r1, [r0, #0]	@  scrolling_x
	ldr	r3, [ip, #0]	@  bg0map
	add	r2, r2, #1
	ldr	r0, .L288
	bl	hitDetection
...
.L280:
	...
	cmp	r0, #0
	ldreq	r4, .L288
	streq	r0, [r4, #20]	@  moveableHead.hSpeed
	beq	.L281
	ldr	r4, .L288
	ldr	r3, [r4, #0]	@  moveableHead.parentSprite
	ldrb	r2, [r3, #3]	@ zero_extendqisi2
...
scrollControls:
	...
	bgt	.L292
	ldr	r7, .L315+4
	ldr	r2, [r7, #0]	@  moveableHead.parentSprite
	ldrh	r3, [r2, #2]
	mov	r3, r3, asl #23
	mov	r3, r3, lsr #23
	cmp	r3, #160
...
downScroll:
	...
	ldr	ip, .L324
	ldr	r1, .L324+4
	ldr	r0, [ip, #0]	@  moveableHead.parentSprite
	ldr	r3, [r1, #0]	@  scrolling_y
	ldrb	r2, [r0, #0]	@ zero_extendqisi2	@  <variable>.fields.y
	add	r3, r3, #1
	sub	r2, r2, #1
	str	r3, [r1, #0]	@  scrolling_y
	strb	r2, [r0, #0]	@  <variable>.fields.y
	ldr	r1, [ip, #28]	@  currentMove,  moveableHead.next
	cmp	r1, #0	@  currentMove
	@ lr needed for prologue
	bxeq	lr
.L321:
	ldr	r2, [r1, #0]	@  <variable>.parentSprite
	ldrb	r3, [r2, #0]	@ zero_extendqisi2	@  <variable>.fields.y
	sub	r3, r3, #1
	strb	r3, [r2, #0]	@  <variable>.fields.y
	ldr	r1, [r1, #28]	@  currentMove,  <variable>.next
	cmp	r1, #0	@  currentMove
	bne	.L321
	bx	lr
.L325:
...
.L324:
	.word	moveableHead
	.word	scrolling_y
	.size	downScroll, .-downScroll
	.align	2
	.global	upScroll
	.type	upScroll, %function
upScroll:
	@ Function supports interworking.
	@ args = 0, pretend = 0, frame = 0
	@ frame_needed = 0, uses_anonymous_args = 0
...
rightScroll:
	...
	sub	fp, ip, #4
	sub	sp, sp, #16
	ldr	ip, [r0, #0]	@  moveableHead.parentSprite
	ldrh	r1, [ip, #2]
	ldr	lr, .L349+4
	mov	r3, r1, asl #23
	ldr	r2, [lr, #0]	@  scrolling_x
	ldr	r0, [r0, #28]	@  currentMove,  moveableHead.next
	sub	r3, r3, #8388608
	orr	r3, r3, r1, lsr #9
	add	r2, r2, #1
	mov	r3, r3, ror #23
	cmp	r0, #0	@  currentMove
	str	r2, [lr, #0]	@  scrolling_x
	strh	r3, [ip, #2]	@ movhi 
	beq	.L347
.L339:
	ldr	r1, [r0, #0]	@  <variable>.parentSprite
	ldrh	r2, [r1, #2]
	mov	r3, r2, asl #23
	sub	r3, r3, #8388608
	orr	r3, r3, r2, lsr #9
	mov	r3, r3, ror #23
	strh	r3, [r1, #2]	@ movhi 
	ldr	r0, [r0, #28]	@  currentMove,  <variable>.next
	cmp	r0, #0	@  currentMove
	bne	.L339
.L347:
	ldr	r2, [lr, #0]	@  scrolling_x
...
.L348:
	...
	ldr	lr, [r3, #0]	@  bg0map
	mov	r4, #32
	ldr	ip, [r7, #0]	@  nextRightDestination
	mov	r3, r4
...
.L397:
	...
	.word	sprites
	.word	tongueHitBox
	.size	tongueControls, .-tongueControls
	.align	2
	.global	draw
	.type	draw, %function
draw:
...
getLocationValue:
	...
	.comm	song, 4, 32
	.comm	songLength, 4, 32
	.comm	channelMus, 12, 32
	.comm	nextRight, 4, 32
	.comm	nextLeft, 4, 32
